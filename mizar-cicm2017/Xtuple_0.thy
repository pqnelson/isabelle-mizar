...
proof (induct rule: assume_means_property[OF xtuple_0_def_2_prefix_def assms, of x,  case_names existence uniqueness coherence])
  case existence
    assume "x is pair"
...
proof 
  ...
  have "x in {x}" using tarski_def_2 by simp
...
lemmas [simp] = xtuple_0_def_12[THEN conjunct1,THEN conjunct1,simplified,rule_format,OF all_set]
...
lemmas [simp] = xtuple_0_def_13[THEN conjunct1,THEN conjunct1,simplified,rule_format,OF all_set]
