...
definition total :: "Set \<Rightarrow>Attr" ( " _ : total "[90] 190) where partfun_1_def_2a[THEN defattr_property,simp]:
  "X :total \<equiv> define_attr (\<lambda> IT. IT be (X-defined \<parallel> Relation) & dom IT = X)"
