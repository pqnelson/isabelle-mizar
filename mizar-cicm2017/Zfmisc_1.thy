...
lemmas zfmisc_1_def_2a[simp] = zfmisc_1_def_2[unfolded atomize_conjL[symmetric],THEN conjunct1,THEN conjunct1,OF all_set all_set]
    ...
    proof (rule iffI3)
      show "z in [:{x},{y}:] implies z in {[x,y]}"
       ...
       qed
        ...
        thus  "z in  [:{x},{y}:]" using A3 zfmisc_1_def_2 by simp 
     qed
qed
