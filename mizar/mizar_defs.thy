...
text_raw \<open>\DefineSnippet{cluster_functorialfor }{\<close>
...
text_raw \<open>\DefineSnippet{let_redefine_func_coherence_means}{\<close>
...
qed
text_raw \<open>\DefineSnippet{equals_property}{\<close>
...
text_raw \<open>\DefineSnippet{attr_property}{\<close>
lemma attr_property:
