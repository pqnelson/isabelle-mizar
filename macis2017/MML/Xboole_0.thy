...
definition prefix_empty::Attr ("empty")
...
lemmas xboole_0_def_2a[simp,type_infer] = xboole_0_def_2[THEN conjunct1]
...
lemmas xboole_0_def_3a[simp,type_infer] = xboole_0_def_3[unfolded atomize_conjL[symmetric],THEN conjunct1,THEN conjunct1,OF all_set,OF all_set]
...
theorem xboole_0_def_3_commutativity: 
  "commutativity set xboole_0_def_3" by (intro ballI, rule tarski_0_2[rule_format],auto)
...
theorem xboole_0_def_3_idempotence: 
  "idempotence set xboole_0_def_3" by (rule ballI, rule tarski_0_2[rule_format],auto)
  text_raw \<open>}%EndSnippet\<close>
...
lemmas xboole_0_def_4a[simp,type_infer] = xboole_0_def_4[unfolded atomize_conjL[symmetric],THEN conjunct1,THEN conjunct1,OF all_set,OF all_set]
...
proof(intro ballI)
  ...
  thus "X \<inter> Y = Y \<inter> X" using tarski_th_2[of "X\<inter>Y" "Y\<inter>X"] T1 by auto
qed
...
definition prefix_min (infixl "\\" 70) where (*let X be set & Y be set*)
"
...
lemmas xboole_0_def_5a[simp,type_infer] = xboole_0_def_5[unfolded atomize_conjL[symmetric],THEN conjunct1,THEN conjunct1,OF all_set]

lemmas xboole_0_def_5aa[simp,type_infer] = xboole_0_def_5[unfolded atomize_conjL[symmetric],THEN conjunct1,THEN conjunct1,OF all_set,OF all_set]
...
theorem xboole_0_cl_2[simp,type_infer]:
...
proof
  ...
  thus "X = {}" using assms tarski_th_2[of X "{}"] by auto
qed
